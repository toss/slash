 ...
 * @deprecated
 * @name ImpressionArea
 * @description `@tossteam/impression-area`를 `ImpressionArea` 를 사용하세요
 */
...
/** @deprecated `@tossteam/impression-area` 의 `ImpressionArea` 를 사용하세요 */
export default ImpressionArea;

/** @deprecated `@tossteam/impression-area` 의 `useImpressionRef` 를 사용하세요 */
